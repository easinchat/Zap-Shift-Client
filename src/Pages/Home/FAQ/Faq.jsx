  ...
  return (
    <div>
      <div className="text-center my-7">
        <h2 className="text-4xl font-bold text-secondary my-7">
      ...
      <div className="collapse collapse-arrow bg-base-100 border border-base-300 has-[input:checked]:bg-[#7AB1B7] has-[input:checked]:text-white">
